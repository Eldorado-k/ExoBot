...
async def cb_handler(client, query: CallbackQuery):
    ...
    if data == "home":
        ...
        await query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• Retour", callback_data="help"), InlineKeyboardButton("Propriétaire •", url='https://t.me/ZeeXContactBot')]
            ])
        )
        ...
        await query.message.edit_caption(
            ...
            reply_markup=InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("• Retour", callback_data="help"), InlineKeyboardButton("Acheter Premium •", url='https://t.me/ZeeXContactBot')]
            ])
        )
    elif data == "plans":
        await query.message.edit_caption(
            ...
            reply_markup=InlineKeyboardMarkup([
                [InlineKeyboardButton("• Fermer", callback_data="close"), InlineKeyboardButton("Acheter Premium •", url='https://t.me/ZeeXContactBot')]
            ])
        )
    elif data == "about":
        await query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup([
                ...
                [InlineKeyboardButton("• Développeur", url='https://t.me/ZeeXContactBot'), InlineKeyboardButton("Réseau •", url='https://t.me/ZeeXClub')],
...
async def donation(client, message):
    buttons = InlineKeyboardMarkup([
        [InlineKeyboardButton(text="Retour", callback_data="help"), InlineKeyboardButton(text="Propriétaire", url='https://t.me/ZeeXContactBot')]
    ])
...
async def getpremium(bot, message):
    buttons = InlineKeyboardMarkup([
        [InlineKeyboardButton("• Offres •", callback_data='plans')],
        [InlineKeyboardButton("Propriétaire", url="https://t.me/ZeeXContactBot"), InlineKeyboardButton("Fermer", callback_data="close")]
    ])
...
async def premium(bot, message):
    buttons = InlineKeyboardMarkup([
        [InlineKeyboardButton("Envoyer capture", url="https://t.me/ZeeXContactBot"), InlineKeyboardButton("Fermer", callback_data="close")]
    ])
