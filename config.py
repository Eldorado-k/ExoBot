...
<b>‣ Exemple : </b> `/autorenommer Série [Ssaison Eépisode] - [Dual] qualité`
...
<b>‣ /Autorenommer : Renommez vos fichiers multimédias en incluant les variables 'épisode' et 'qualité' dans votre texte, pour extraire l'épisode et la qualité présents dans le nom de fichier original.</b>"""
    ...
    ABOUT_TXT = f"""<b>❍ Mon nom : <a href="https://t.me/Auto_Rename_ZeeBot">Auto Renommage</a>
❍ Développeur : <a href="https://t.me/ZeeTECH">Zee</a>
...
❍ Chaîne principale : <a href="https://t.me/ZeeTECH">Zee TECH</a>
...
➲ Étape 2 : Envoyez la capture du paiement à @ZeeTECHBot.
...
➜ Hébergement de bot : Contactez @ZeeTECHBot
